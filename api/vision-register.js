    ...
    if (email) {
      try {
        await resend.emails.send({
          ...
          html: `<div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;color:#1A1613;background-color:#ffffff;"><div style="background:#ffffff;padding:24px 24px 16px;text-align:center;border-bottom:3px solid #C8922A;margin-bottom:32px;">
