    ...
    if (records && records[0] && records[0].parent_email) {
      try {
        ...
        await resend.emails.send({
          ...
          html: '<div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;color:#1A1613;"><div style="background:#0D0D0D;padding:24px;text-align:center;margin-bottom:32px;"><img src="https://kim.church/kim-logo-email.png" alt="Kingdom Insights Ministries" style="height:60px;"></div><div style="padding:0 24px 24px;">' +
